...
$_['text_edit']           	   = '編輯Fulfillment by Amazon settings';
...
$_['help_debug_log']  		   = 'Debug logs will record information to a log file about 動作s the module does. This should be left enabled to help find the cause of any problems.';
