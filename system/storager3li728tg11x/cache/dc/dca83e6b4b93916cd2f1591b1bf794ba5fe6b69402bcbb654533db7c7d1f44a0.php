...
/* pav_celo/template/common/currency.twig */
class __TwigTemplate_be56608c0e7eed9927473f29d5f774c6f0127da70e8034cbfdf1ce80be7a4d03 extends Twig_Template
{
  ...
  <form action=\"";
            ...
            echo "\" method=\"post\" enctype=\"multipart/form-data\" id=\"form-currency\" class=\"form-currency\">
    <div class=\"btn-group\">
...
";
    ...
    {
        return "pav_celo/template/common/currency.twig";
    }
...
/* <div class="pull-left">*/
/*   <form action="{{ action }}" method="post" enctype="multipart/form-data" id="form-currency" class="form-currency">*/
/*     <div class="btn-group">*/
