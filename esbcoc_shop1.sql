...
INSERT INTO `op_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2018-11-30 18:18:36', '2018-11-30 18:18:36');
...
--
-- 資料表結構 `op_api_session`
--

CREATE TABLE `op_api_session` (
...
--
-- 資料表的匯出資料 `op_attribute`
--

INSERT INTO `op_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- 資料表結構 `op_attribute_description`
--
...
--
-- 資料表的匯出資料 `op_attribute_description`
--

INSERT INTO `op_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- 資料表的匯出資料 `op_attribute_group`
--

INSERT INTO `op_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- 資料表結構 `op_attribute_group_description`
--
...
--
-- 資料表的匯出資料 `op_attribute_group_description`
--

INSERT INTO `op_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor'),
...
INSERT INTO `op_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
--
-- 資料表的匯出資料 `op_banner_image`
--

INSERT INTO `op_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
--
-- 資料表的匯出資料 `op_category`
--

INSERT INTO `op_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表的匯出資料 `op_category_description`
--

INSERT INTO `op_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- 資料表結構 `op_category_filter`
--

CREATE TABLE `op_category_filter` (
  `category_id` int(11) NOT NULL,
...
--
-- 資料表結構 `op_category_path`
--

CREATE TABLE `op_category_path` (
  `category_id` int(11) NOT NULL,
...
--
-- 資料表的匯出資料 `op_category_path`
--

INSERT INTO `op_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
--
-- 資料表的匯出資料 `op_category_to_store`
--

INSERT INTO `op_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
INSERT INTO `op_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
INSERT INTO `op_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- 資料表結構 `op_coupon_category`
--

CREATE TABLE `op_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表的匯出資料 `op_currency`
--

INSERT INTO `op_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
--
-- 資料表結構 `op_customer_activity`
--

CREATE TABLE `op_customer_activity` (
...
--
-- 資料表結構 `op_customer_affiliate`
--

CREATE TABLE `op_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
--
-- 資料表結構 `op_customer_approval`
--

CREATE TABLE `op_customer_approval` (
...
--
-- 資料表的匯出資料 `op_customer_group`
--

INSERT INTO `op_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);

-- --------------------------------------------------------

--
-- 資料表結構 `op_customer_group_description`
--
...
--
-- 資料表的匯出資料 `op_customer_group_description`
--
...
--
-- 資料表結構 `op_customer_history`
--

CREATE TABLE `op_customer_history` (
...
--
-- 資料表結構 `op_customer_login`
--

CREATE TABLE `op_customer_login` (
...
--
-- 資料表結構 `op_customer_search`
--

CREATE TABLE `op_customer_search` (
...
--
-- 資料表結構 `op_customer_wishlist`
--

CREATE TABLE `op_customer_wishlist` (
  `customer_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `date_added` datetime NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表結構 `op_custom_field`
--

CREATE TABLE `op_custom_field` (
...
--
-- 資料表結構 `op_custom_field_customer_group`
--

CREATE TABLE `op_custom_field_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
...
--
-- 資料表結構 `op_custom_field_description`
--

CREATE TABLE `op_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表結構 `op_custom_field_value`
--

CREATE TABLE `op_custom_field_value` (
...
--
-- 資料表結構 `op_custom_field_value_description`
--

CREATE TABLE `op_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
INSERT INTO `op_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- 資料表的匯出資料 `op_extension`
--

INSERT INTO `op_extension` (`extension_id`, `type`, `code`) VALUES
(1, 'payment', 'cod'),
(2, 'total', 'shipping'),
(3, 'total', 'sub_total'),
(4, 'total', 'tax'),
...
--
-- 資料表結構 `op_extension_install`
--

CREATE TABLE `op_extension_install` (
...
--
-- 資料表結構 `op_extension_path`
--

CREATE TABLE `op_extension_path` (
...
--
-- 資料表結構 `op_filter_description`
--

CREATE TABLE `op_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
--
-- 資料表結構 `op_filter_group`
--

CREATE TABLE `op_filter_group` (
  `filter_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表結構 `op_filter_group_description`
--

CREATE TABLE `op_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表的匯出資料 `op_geo_zone`
--

INSERT INTO `op_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表的匯出資料 `op_information`
--

INSERT INTO `op_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
...
--
-- 資料表結構 `op_information_description`
--
...
--
-- 資料表的匯出資料 `op_information_description`
--

INSERT INTO `op_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
--
-- 資料表結構 `op_information_to_layout`
--
...
--
-- 資料表的匯出資料 `op_information_to_store`
--

INSERT INTO `op_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);
...
INSERT INTO `op_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- 資料表結構 `op_layout_module`
--

CREATE TABLE `op_layout_module` (
...
--
-- 資料表的匯出資料 `op_layout_module`
--

INSERT INTO `op_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
--
-- 資料表的匯出資料 `op_layout_route`
--

INSERT INTO `op_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38, 6, 0, 'account/%'),
(17, 10, 0, 'affiliate/%'),
...
--
-- 資料表的匯出資料 `op_length_class`
--

INSERT INTO `op_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- 資料表結構 `op_length_class_description`
--
...
--
-- 資料表的匯出資料 `op_length_class_description`
--
...
--
-- 資料表的匯出資料 `op_manufacturer`
--

INSERT INTO `op_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- 資料表結構 `op_manufacturer_to_store`
--
...
--
-- 資料表的匯出資料 `op_manufacturer_to_store`
--

INSERT INTO `op_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- 資料表結構 `op_modification`
--

CREATE TABLE `op_modification` (
...
INSERT INTO `op_module` (`module_id`, `name`, `code`, `setting`) VALUES
...
INSERT INTO `op_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
--
-- 資料表的匯出資料 `op_option_description`
--

INSERT INTO `op_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- 資料表的匯出資料 `op_option_value`
--

INSERT INTO `op_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- 資料表結構 `op_option_value_description`
--
...
--
-- 資料表的匯出資料 `op_option_value_description`
--

INSERT INTO `op_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- 資料表結構 `op_order_recurring`
--

CREATE TABLE `op_order_recurring` (
...
--
-- 資料表結構 `op_order_recurring_transaction`
--

CREATE TABLE `op_order_recurring_transaction` (
...
--
-- 資料表結構 `op_order_shipment`
--

CREATE TABLE `op_order_shipment` (
...
--
-- 資料表的匯出資料 `op_order_status`
--

INSERT INTO `op_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
INSERT INTO `op_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `viewed`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表的匯出資料 `op_product_attribute`
--

INSERT INTO `op_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- 資料表的匯出資料 `op_product_description`
--
...
--
-- 資料表的匯出資料 `op_product_discount`
--

INSERT INTO `op_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- 資料表結構 `op_product_filter`
--

CREATE TABLE `op_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表的匯出資料 `op_product_image`
--

INSERT INTO `op_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- 資料表的匯出資料 `op_product_option`
--

INSERT INTO `op_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(224, 35, 11, '', 1),
...
--
-- 資料表的匯出資料 `op_product_option_value`
--

INSERT INTO `op_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- 資料表結構 `op_product_recurring`
--

CREATE TABLE `op_product_recurring` (
  `product_id` int(11) NOT NULL,
  `recurring_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表的匯出資料 `op_product_related`
--

INSERT INTO `op_product_related` (`product_id`, `related_id`) VALUES
(40, 42),
(41, 42),
(42, 40),
(42, 41);
...
--
-- 資料表的匯出資料 `op_product_reward`
--

INSERT INTO `op_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(515, 42, 1, 100),
(519, 47, 1, 300),
(379, 28, 1, 400),
(329, 43, 1, 600),
...
--
-- 資料表的匯出資料 `op_product_special`
--

INSERT INTO `op_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- 資料表的匯出資料 `op_product_to_category`
--

INSERT INTO `op_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
--
-- 資料表的匯出資料 `op_product_to_store`
--

INSERT INTO `op_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
--
-- 資料表結構 `op_recurring_description`
--

CREATE TABLE `op_recurring_description` (
  `recurring_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
--
-- 資料表的匯出資料 `op_return_reason`
--

INSERT INTO `op_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
INSERT INTO `op_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
('991e7e403d235bb542e24cab6a', '{\"language\":\"zh-hk\",\"currency\":\"USD\",\"user_id\":\"1\",\"user_token\":\"iXoyCsPlMkihMp5Pgllgii6ozJeQeiCF\",\"install\":\"9yLaNhbpaZ\"}', '2018-12-04 11:16:15'),
...
--
-- 資料表結構 `op_shipping_courier`
--

CREATE TABLE `op_shipping_courier` (
...
--
-- 資料表的匯出資料 `op_shipping_courier`
--

INSERT INTO `op_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1, 'dhl', 'DHL'),
(2, 'fedex', 'Fedex'),
(3, 'ups', 'UPS'),
...
--
-- 資料表的匯出資料 `op_statistics`
--

INSERT INTO `op_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', '0.0000'),
...
--
-- 資料表的匯出資料 `op_stock_status`
--

INSERT INTO `op_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2-3 Days'),
...
--
-- 資料表的匯出資料 `op_tax_class`
--

INSERT INTO `op_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表的匯出資料 `op_tax_rate`
--

INSERT INTO `op_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表結構 `op_tax_rate_to_customer_group`
--
...
--
-- 資料表的匯出資料 `op_tax_rate_to_customer_group`
--

INSERT INTO `op_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- 資料表的匯出資料 `op_tax_rule`
--

INSERT INTO `op_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- 資料表結構 `op_translation`
--

CREATE TABLE `op_translation` (
...
--
-- 資料表的匯出資料 `op_voucher_theme`
--

INSERT INTO `op_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- 資料表結構 `op_voucher_theme_description`
--
...
--
-- 資料表的匯出資料 `op_voucher_theme_description`
--
...
--
-- 資料表的匯出資料 `op_weight_class`
--

INSERT INTO `op_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- 資料表結構 `op_weight_class_description`
--
...
--
-- 資料表的匯出資料 `op_weight_class_description`
--

INSERT INTO `op_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz'),
...
INSERT INTO `op_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- 資料表的匯出資料 `op_zone_to_geo_zone`
--

INSERT INTO `op_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
...
--
-- 資料表索引 `op_attribute_description`
--
ALTER TABLE `op_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- 資料表索引 `op_attribute_group`
--
ALTER TABLE `op_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- 資料表索引 `op_attribute_group_description`
--
ALTER TABLE `op_attribute_group_description`
...
--
-- 資料表索引 `op_category_description`
--
ALTER TABLE `op_category_description`
  ADD PRIMARY KEY (`category_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- 資料表索引 `op_category_filter`
--
ALTER TABLE `op_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- 資料表索引 `op_category_path`
--
ALTER TABLE `op_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- 資料表索引 `op_category_to_layout`
--
ALTER TABLE `op_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- 資料表索引 `op_category_to_store`
--
ALTER TABLE `op_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);
...
--
-- 資料表索引 `op_coupon_category`
--
ALTER TABLE `op_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- 資料表索引 `op_coupon_history`
--
ALTER TABLE `op_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- 資料表索引 `op_coupon_product`
--
...
--
-- 資料表索引 `op_customer_activity`
--
ALTER TABLE `op_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- 資料表索引 `op_customer_affiliate`
--
ALTER TABLE `op_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- 資料表索引 `op_customer_approval`
--
ALTER TABLE `op_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- 資料表索引 `op_customer_group`
--
ALTER TABLE `op_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- 資料表索引 `op_customer_group_description`
--
ALTER TABLE `op_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- 資料表索引 `op_customer_history`
--
ALTER TABLE `op_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- 資料表索引 `op_customer_ip`
--
...
--
-- 資料表索引 `op_customer_online`
--
ALTER TABLE `op_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- 資料表索引 `op_customer_reward`
--
ALTER TABLE `op_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- 資料表索引 `op_customer_search`
--
ALTER TABLE `op_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- 資料表索引 `op_customer_transaction`
--
ALTER TABLE `op_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- 資料表索引 `op_customer_wishlist`
--
ALTER TABLE `op_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- 資料表索引 `op_custom_field`
--
ALTER TABLE `op_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- 資料表索引 `op_custom_field_customer_group`
--
ALTER TABLE `op_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- 資料表索引 `op_custom_field_description`
--
ALTER TABLE `op_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- 資料表索引 `op_custom_field_value`
--
ALTER TABLE `op_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- 資料表索引 `op_custom_field_value_description`
--
ALTER TABLE `op_custom_field_value_description`
...
--
-- 資料表索引 `op_download_description`
--
ALTER TABLE `op_download_description`
...
--
-- 資料表索引 `op_extension_install`
--
ALTER TABLE `op_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- 資料表索引 `op_extension_path`
--
...
--
-- 資料表索引 `op_filter_description`
--
ALTER TABLE `op_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- 資料表索引 `op_filter_group`
--
ALTER TABLE `op_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- 資料表索引 `op_filter_group_description`
--
ALTER TABLE `op_filter_group_description`
...
--
-- 資料表索引 `op_information`
--
ALTER TABLE `op_information`
  ADD PRIMARY KEY (`information_id`);

--
-- 資料表索引 `op_information_description`
--
ALTER TABLE `op_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- 資料表索引 `op_information_to_layout`
--
ALTER TABLE `op_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- 資料表索引 `op_information_to_store`
--
ALTER TABLE `op_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);
...
--
-- 資料表索引 `op_layout_module`
--
ALTER TABLE `op_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- 資料表索引 `op_layout_route`
--
ALTER TABLE `op_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- 資料表索引 `op_length_class`
--
ALTER TABLE `op_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- 資料表索引 `op_length_class_description`
--
ALTER TABLE `op_length_class_description`
...
--
-- 資料表索引 `op_manufacturer`
--
ALTER TABLE `op_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- 資料表索引 `op_manufacturer_to_store`
--
ALTER TABLE `op_manufacturer_to_store`
...
--
-- 資料表索引 `op_option_description`
--
ALTER TABLE `op_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- 資料表索引 `op_option_value`
--
ALTER TABLE `op_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- 資料表索引 `op_option_value_description`
--
ALTER TABLE `op_option_value_description`
...
--
-- 資料表索引 `op_product_attribute`
--
ALTER TABLE `op_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- 資料表索引 `op_product_description`
--
ALTER TABLE `op_product_description`
  ADD PRIMARY KEY (`product_id`,`language_id`),
  ADD KEY `name` (`name`);

--
-- 資料表索引 `op_product_discount`
--
...
--
-- 資料表索引 `op_product_filter`
--
ALTER TABLE `op_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- 資料表索引 `op_product_image`
--
...
--
-- 資料表索引 `op_product_option`
--
ALTER TABLE `op_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- 資料表索引 `op_product_option_value`
--
ALTER TABLE `op_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- 資料表索引 `op_product_recurring`
--
ALTER TABLE `op_product_recurring`
  ADD PRIMARY KEY (`product_id`,`recurring_id`,`customer_group_id`);

--
-- 資料表索引 `op_product_related`
--
ALTER TABLE `op_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- 資料表索引 `op_product_reward`
--
ALTER TABLE `op_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- 資料表索引 `op_product_special`
--
...
--
-- 資料表索引 `op_product_to_category`
--
ALTER TABLE `op_product_to_category`
  ADD PRIMARY KEY (`product_id`,`category_id`),
  ADD KEY `category_id` (`category_id`);

--
-- 資料表索引 `op_product_to_download`
--
ALTER TABLE `op_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- 資料表索引 `op_product_to_layout`
--
ALTER TABLE `op_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- 資料表索引 `op_product_to_store`
--
ALTER TABLE `op_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);
...
--
-- 資料表索引 `op_recurring_description`
--
ALTER TABLE `op_recurring_description`
...
--
-- 資料表索引 `op_shipping_courier`
--
ALTER TABLE `op_shipping_courier`
...
--
-- 資料表索引 `op_tax_rate_to_customer_group`
--
ALTER TABLE `op_tax_rate_to_customer_group`
...
--
-- 資料表索引 `op_voucher_history`
--
ALTER TABLE `op_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- 資料表索引 `op_voucher_theme`
--
ALTER TABLE `op_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- 資料表索引 `op_voucher_theme_description`
--
ALTER TABLE `op_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- 資料表索引 `op_weight_class`
--
ALTER TABLE `op_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- 資料表索引 `op_weight_class_description`
--
ALTER TABLE `op_weight_class_description`
...
--
-- 使用資料表 AUTO_INCREMENT `op_address`
--
ALTER TABLE `op_address`
